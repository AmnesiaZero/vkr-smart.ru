    ...
    <div class="col-xl-9 col-lg-8 col-md-7 col-12">
        ...
        <div class="pt-3 px-md-0 px-3 position-relative">
            <div class="big-table">
                <table class="table fs-14">
                    ...
                    <tr class="text-grey">
                        ...
                        <th scope="col"><img src="img/nine_dots.svg" alt="" class="pb-2"></th>
                    </tr>
                    </thead>
            ...
            <div class="info-box" id="info_box">
                ...
                <div class="d-flex cursor-p mb-2">
                    <img src="img/copy.svg" alt="" class="pe-2">
                    <p class="fs-14 lh-17 text-grey m-0">Сделать копию записи без создания файлов</p>
                </div>
                <div class="d-flex cursor-p mb-2">
                    <img src="img/Trash_Full.svg" alt="" class="pe-2">
                ...
                <div class="d-flex cursor-p mb-2">
                    <img src="img/href_light.svg" alt="" class="pe-2">
