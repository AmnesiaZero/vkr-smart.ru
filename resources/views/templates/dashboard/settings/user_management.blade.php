...
@section('content')
        ...
        <div class="row pt-4 g-3 px-md-0 px-3">
            ...
            <div class="col">
                ...
                <div class="form-check">
                    <input class="form-check-input green" type="radio" name="status" id="status1" checked>
                    <label class="form-check-label" for="status1">
                        активен
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input green" type="radio" name="status" id="status2">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="br-green-light-1 p-3 br-15">
                        ...
                        <div class="border-left ps-3">
                            <p class="text-grey fs-14 m-0">Группа: 156а</p>
                            <p class="text-grey fs-14 m-0">13.03.2020</p>
                            <p class="text-grey fs-14 m-0">koshelev76@mail.ru</p>
                        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit">
        ...
        <div class="offcanvas-body">
            ...
            <div class="brt-green-light-2">
                <div class="px-4 pt-4">
                    <p>Подразделение:</p>
                    <div class="out-kod"></div>
                    <div id="tree_1" class="br-green-light-2 br-15 p-3">
                        <ul class="ui-fancytree fancytree-container fancytree-plain" tabindex="0">
                            <li class="">
		    							<span
                                            class="fancytree-node fancytree-expanded fancytree-folder fancytree-has-children fancytree-exp-e fancytree-ico-ef">
                    ...
                    <button class="btn btn-secondary br-100 br-none w-100 fs-14 text-grey py-1 mt-5">Сохранить</button>
                </div>
            </div>
        </div>
        @endsection
