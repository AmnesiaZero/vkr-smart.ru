                    ...
                    <div class="border-bottom pt-4">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-5">
                                ...
                                <div id="lock1" class="mt-2"><img src="/images/Lock_1.svg" alt="" id="/imageslock"><a
                                        href="#" class="text-grey link-active-hover fs-14 ps-2" id="lock_text">заблокировать</a>
                                </div>
                                ...
                                <div class="pas cursor-p mt-2">
                                    ...
                                    <div class="input-group mb-3 mt-2 copy_box" style="width: max-content;">
                                        <input type="text" class="form-control form-copy" id="content"
                                               value="koshelev76" size="8" aria-describedby="button-addon2" readonly>
                    ...
                    <div class="border-bottom pt-4">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-5">
                                ...
                                <div id="lock3" class="mt-2"><img src="/images/Lock_1.svg" alt="" id="/imageslock3"><a
                                        href="#" class="text-grey link-active-hover fs-14 ps-2" id="lock_text3">заблокировать</a>
                                </div>
                                <p class="text-grey fs-14 pt-4">13.03.2020</p>
                                <p class="text-grey fs-14">(791) 720-18-75</p>
                                <p class="text-grey fs-14 mb-0">koshelev76@mail.ru</p>
