                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <span class="d-flex inline-flex br-green-light-2 br-100 px-3 text-pale-grey fs-14 align-items-center" style="width: 124px">
					                            <span class="d-flex inline-flex align-items-center">
					                                <button type="button" onclick="dec('amount')" class="btn btn-minus btn-minus-white"></button>
					                                <input id="amount" type="text" name="amount" step="1" class="form-control text-blue form-control-minute-custom fs-14" readonly="" value="0">
					                                <button type="button" onclick="inc('amount')" class="btn btn-plus btn-plus-white"></button>
					                            </span>
					                        </span>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-secondary br-none text-grey br-100 w-100 mt-4 fs-14 p-btn">сгенерировать</button>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-5 col-xl-6 col-lg-8 col-md-12 col-12 mb-3">
                    <div class="br-green-light-2 br-15 p-3">
                        <div class="d-flex inline-flex justify-content-between mb-3">
                            ...
                            <span class="badge bg-green br-100 text-grey fs-14 cursor-p ps-3">выгрузить <img src="/images/File_Download.svg" alt="" class="ps-1 pe-2"></span>
                        </div>
                        <div class="border-bottom mb-2">
                            <div class="input-group mb-0 br-none" style="width: max-content;">
                                <input type="text" class="form-control form-copy br-none text-black ps-0" id="content" value="180360-68858" aria-describedby="button-addon2" size="10" readonly>
