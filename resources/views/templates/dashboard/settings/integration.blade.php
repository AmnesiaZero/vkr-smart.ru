    ...
    <div class="col-xl-9 col-lg-8 col-md-7 col-12">
        <div class="row px-5 pt-5 g-3">
            <div class="col-xxl-6 col-lg-10 col-12">
                ...
                <p class="fs-14 text-grey lh-17 col-9">Для Вашей организации зарезервированы следующие параметры, необходимые для проведения интеграции со сторонними платформами в рамках бесшовных переходов:</p>
                <div class="d-flex flex-inline">
                    ...
                    <div class="input-group mb-3" style="width: max-content;">
                        <input type="text" class="form-control form-copy" id="content" value="595" size="2" aria-describedby="button-addon2" readonly>
                        <button id="copy" class="btn copy_btn" type="button" id="button-addon2"></button>
                    </div>
                </div>
                <p class="fs-14 text-grey lh-17 mb-2">Ключевая фраза, необходимая <br>для шифрования исходных данных:</p>
                <div class="input-group" style="width: max-content;">
                    <input type="text" class="form-control form-copy" id="content_1" value="JSQvqtezPKmWLpCvzftmkBy87Krdhpuq" aria-describedby="button-addon3" readonly>
        ...
        <div class="row p-5">
            <div class="col-12">
                ...
                <ol type="1" class="text-grey fs-14 ps-3">
                    ...
                    <li>Реализовать функционал бесшовного перехода из портала в систему ВКР-ВУЗ.РФ, согласно следующей спецификации:</li>
                </ol>
                <p class="text-grey fs-14 lh-17 mb-2">Полученный секретный код участвует в формировании нового ключа, зависящего от даты его генерации.</p>
                <p class="text-grey fs-14 lh-17 mb-2">На страницу <a href="#" class="text-grey">сервиса автоматического входа</a> обязательно должны быть переданы следующие параметры:</p>
                <ul class="text-grey fs-14">
                    ...
                    <li>Уникальный ключ, сфомированный как MD5({$uid}.{$secret_key}.{$time}). $secret_key – ключевая фраза, указанная выше.</li>
                </ul>
                ...
                <a href="http://www.vkr-vuz.ru/autologin?&domain=595&id=31252&time=20230217181850&sign=a38647e6ab5be848682afc0975e62d70" class="text-grey fs-14 td-none ww-break">http://www.vkr-vuz.ru/autologin?&domain=595&id=31252&time=20230217181850&sign=a38647e6ab5be848682afc0975e62d70</a>
            </div>
        </div>
    </div>
@endsection
