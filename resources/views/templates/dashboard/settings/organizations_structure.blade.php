                    ...
                    <div class="tab-content bg-white br-blue-grey-1 bbrr-20 bblr-20 " id="myQuestionsContent">
                        <div class="tab-pane fade active show" id="base" role="tabpanel" aria-labelledby="base-tab">
                            ...
                            <div class="d-flex inline-flex ps-4" id="level_education_group">
                                <div class="form-check">
                                    <input class="form-check-input green" type="radio" name="level_education" id="level_education_1" value="1">
                                    <label class="form-check-label" for="level_education_1">
                                        СПО
                                    </label>
                                </div>
                                <div class="form-check ms-5">
                                    <input class="form-check-input green" type="radio" name="level_education" id="level_education_2" value="2">
                            ...
                            <div class="row ps-4" id="level_group">
                                <div class="col">
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_1" value="1">
                                        <label class="form-check-label" for="level_1">
                                            Бакалавриат
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_2" value="2">
                                        <label class="form-check-label" for="level_2">
                                            Магистратура
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_3" value="3">
                                        <label class="form-check-label" for="level_3">
                                            Специалитет
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_4" value="4">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_5" value="5">
                                        <label class="form-check-label" for="level_5">
                                            Адъюнктура
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_6" value="6">
                                        <label class="form-check-label" for="level_6">
                                            Ординатура
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input green" type="radio" name="level" id="level_7" value="7">
                        ...
                        <div class="tab-pane fade" id="own-settings" role="tabpanel" aria-labelledby="own-settings-tab">
                            ...
                            <div class="mb-4 mx-4 col-8">
                                ...
                                <input type="text" class="form-control bg-grey-form" name="code" id="code_course" value="">
                            </div>
                            <div class="mb-3 mx-4 col-8">
                                <label for="course" class="form-label m-0">направление:</label>
                                <input type="text" class="form-control bg-grey-form" name="name" id="course" value="">
                            </div>
