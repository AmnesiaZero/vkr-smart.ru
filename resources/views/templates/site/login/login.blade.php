        ...
        <div class="row justify-content-center pb-3">
            <div class="col-xl-5 col-lg-6">
                <div class="bg-grey br-40 p-5">
                    ...
                    <p class="fs-14 text-center pt-3 m-0">Забыли пароль? <a href="#" class="text-green">Восстановить</a></p>
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 mt-lg-0 mt-5">
                <div class="bg-grey br-40 p-5">
                    <div class="text-before-form">
                        ...
                        <p class="mb-5 text-grey fs-14 lh-17">Чтобы пройти регистрацию, <br> введите выданный вам код приглашения</p>
                    </div>
