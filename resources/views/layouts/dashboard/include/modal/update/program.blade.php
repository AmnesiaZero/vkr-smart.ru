                ...
                <div class="tab-pane fade active show" id="base" role="tabpanel" aria-labelledby="base-tab">
                    ...
                    <div class="d-flex inline-flex ps-4">
                        <div class="form-check">
                            <input class="form-check-input green" type="radio" name="level_education" id="level_education1" checked>
                            <label class="form-check-label" for="level_education1">
                                СПО
                            </label>
                        </div>
                        <div class="form-check ms-5">
                            <input class="form-check-input green" type="radio" name="level_education" id="level_education2">
                    ...
                    <div class="row ps-4">
                        <div class="col">
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training1" checked>
                                <label class="form-check-label" for="level_training1">
                                    Бакалавриат
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training2">
                                <label class="form-check-label" for="level_training2">
                                    Магистратура
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training3">
                                <label class="form-check-label" for="level_training3">
                                    Специалитет
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training4">
                        ...
                        <div class="col">
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training5">
                                <label class="form-check-label" for="level_training5">
                                    Адъюнктура
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training6">
                                <label class="form-check-label" for="level_training6">
                                    Ординатура
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input green" type="radio" name="level_training" id="level_training7">
