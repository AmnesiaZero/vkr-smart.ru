        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <span
                        style="font-size:13px; display:block; margin:0.5rem 0; color:#999;">Или выберите из списка:</span>
                    <select name="work_teacher" class="form-control">
                        <option value="">Выбрать...</option>
                        @if(isset($scientific_supervisors) and is_iterable($scientific_supervisors))
                            @foreach($scientific_supervisors as $work_type)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="selfcheck" value="1" checked=""> Работа проверена
                            самостоятельно
                        </label>
                    </div>
                </div>
