        ...
        <div class="container align-items-center">
            ...
            <div class="navbar-collapse collapse justify-content-end" id="bdNavbar">
                <ul class="navbar-nav" style="align-items: baseline;">
                    <li><a class="nav-link @if(request()->is('/') or request()->is('home')) nav-link-active @endif"
                           href="/">Главная</a></li>
                    <!--
                    ...
                    <li>
                        <a class="nav-link @if(request()->is('search/*')) nav-link-active @endif"
                           href="/search/borrowings">
                            Поиск заимствований
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="nav-link @if(request()->is('check-reference')) nav-link-active @endif"
        ...
        <div class="container py-4">
            <div class="row g-4">
                <div class="col-lg-3 align-items-center">
                    <img src="/images/VKR.svg" alt="">
                    <p class="pt-1">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#vkrBtnsSetup">Установка кнопки на ваш
                            сайт</a>
                    <div id="vkrBtnsSetup" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="vkrBtnsSetupLabel">Инструкция по установке кнопок
                                        системы хранения ВКР СМАРТ</h5>
                ...
                <div class="col-xxl-7 col-lg-6 col-sm-8 col-12">
                    ...
                    <p class="lh-18 fs-12 m-0">ООО «Профобразование» включено в Реестр аккредитованных IT компаний, на
                        основании РЕШЕНИЯ о предоставлении государственной аккредитации организации, осуществляющей
                        деятельность в области информационных технологий от 17.03.2022 № АО-20 220 316-3 829 208 820-3,
                        выданного МИНИСТЕРСТВОМ ЦИФРОВОГО РАЗВИТИЯ, СВЯЗИ И МАССОВЫХ КОММУНИКАЦИЙ РОССИЙСКОЙ
                        ФЕДЕРАЦИИ.</p>
                </div>
                <div
                    ...
                    <div>
                        ...
                        <a href="https://www.youtube.com/watch?v=jYH8MoxSoP0&list=PLRzHZiF2tgd5RN7sxyGP-5BO55dOvsVIS"
                           target="_blank"> <img src="/images/youtube.svg" alt="YouTube"> </a>
                        <a href="https://t.me/ipredu_online" target="_blank"> <img src="/images/tg.svg" alt="Telegram">
                        </a>
                    </div>
                    <div class="pt-3">
